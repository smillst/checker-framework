...
class MySuperClass {
  public void method(MyGeneric<@NonNull ?> x) {}
}
...
public class Issue511 extends MySuperClass {
  ...
  // method(MyGeneric<@NonNull ?>) in MySuperClass have the same erasure, yet neither
  // overrides the other
  // public void method(MyGeneric<? extends Number> x) {}
  //    ^
  //            1 error
...
class Use {
  MyGeneric<@NonNull ?> wildCardExtendsObject = new MyGeneric<>();
