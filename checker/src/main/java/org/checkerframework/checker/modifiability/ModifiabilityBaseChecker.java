 ...
 * {@code messages.properties} file in {@code org.checkerframework.checker.modifiability}. The
 * Modifiability sub-checkers all report diagnostics whose message keys are defined there; without
 * this common superclass, those keys would need to be duplicated in each sub-checker's package.
 */
