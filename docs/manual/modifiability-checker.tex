...
\begin{verbatim}
  Grow hierarchy           Shrink hierarchy              Replace hierarchy             Iterator hierarchy
    ...
    @MaybeGrowable             @MaybeShrinkable               @MaybeReplaceable          @MaybeIteratorPolyShrinkable
      /      \                 /       \                    /       \                          |
 @Growable @Ungrowable   @Shrinkable @Unshrinkable   @Replaceable @Unreplaceable               |
      \      /                 \       /                    \       /                          |
    @BottomGrowable             @BottomShrinkable                @BottomReplaceable              @IteratorPolyShrinkable
\end{verbatim}
  \end{minipage}
\end{smaller}
...
\begin{description}
\item[\refqualclass{checker/modifiability/qual}{MaybeIteratorPolyShrinkable}]
The top qualifier.
...
\item[\refqualclass{checker/modifiability/qual}{IteratorPolyShrinkable}]
...
\<@IteratorPolyShrinkable>.  The collection uses the first signature if the
collection is \<@MaybeIteratorPolyShrinkable>.

Here are examples of its use:

\begin{Verbatim}
  @IteratorPolyShrinkable @Shrinkable List<String> list = ...;
...
% LocalWords:  MaybeIteratorPolyShrinkable IteratorPolyShrinkable
