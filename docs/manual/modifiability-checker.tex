...
This annotation should only be written on non-void, one-argument method declarations.
...
\sectionAndLabel{Unverified collection implementation annotations}{modifiability-annotation-unverified}
...
\<modifiability.annotation.unverified> warning.  The warning means that the
...
\<modifiability.annotation.unverified>. It is up to the programmer to verify that
