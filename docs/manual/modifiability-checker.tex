...
\begin{itemize}
    ...
    \item \textbf{Sequential Grow}: The sequenced collection can grow by adding new
      ...
      The Sequencial Grow capability is needed for collections, such as
      ...
      ``Sequential Grow'' is shorted to ``SeqGrow'' in the rest of the manual.
...
Should only be written on a non-void, one-argument method declaration.
...
\subsectionAndLabel{Alternative design: use negative capability rather than top qualifier}{modifiability-modifyiable-must-be-top}

An alternative design would use the
