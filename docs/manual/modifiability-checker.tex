...
A \emph{modifiable collection} supports calling at least one optional mutating method. In genernal,
...
\begin{itemize}
    ...
    \item \textbf{Sequential Grow}: A sequenced collection can grow by adding new
      ...
      \<putLast>). (This is shorted to SeqGrow in the rest of the manual.)
...
%% TODO: For each category what methods may or may not be called? I would guess this is in the
% annotated JDK, but where do I find this information?
