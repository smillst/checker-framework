...
The testing infrastructure is extensively documented in file \href{https://github.com/typetools/checker-framework/blob/master/checker/tests/README.md}{\<checker-framework/checker/tests/README.md>}.
